...
HD_PWD='C:/Users/jesud/Desktop/FPGA_Project/decoder_7_seg/decoder_7_seg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_7_seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source decoder_7_seg.tcl -notrace
