...
HD_PWD='C:/Users/jesud/Desktop/FPGA_Project/data_selector_verilog/data_selector_verilog.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log selector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source selector.tcl -notrace
