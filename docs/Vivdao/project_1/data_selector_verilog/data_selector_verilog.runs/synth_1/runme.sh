...
HD_PWD='C:/Users/jesud/Desktop/FPGA_Project/data_selector_verilog/data_selector_verilog.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log selector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source selector.tcl
