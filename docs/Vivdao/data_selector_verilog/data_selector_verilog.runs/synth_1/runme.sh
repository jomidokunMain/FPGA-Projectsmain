...
HD_PWD='/home/jesudara/Desktop/FPGA_projects/Vivdao/data_selector_verilog/data_selector_verilog.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log data_selector1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source data_selector1.tcl
