...
HD_PWD='/home/jesudara/Desktop/FPGA_projects/Vivdao/data_selector/data_selector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dataSel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dataSel.tcl -notrace
