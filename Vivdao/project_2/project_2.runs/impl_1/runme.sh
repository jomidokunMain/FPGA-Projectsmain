...
HD_PWD='/home/jesudara/Desktop/FPGA_projects/Vivdao/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mySWLED.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mySWLED.tcl -notrace
