...
HD_PWD='/home/jesudara/Desktop/FPGA_projects/Vivdao/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mySWLED.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mySWLED.tcl
