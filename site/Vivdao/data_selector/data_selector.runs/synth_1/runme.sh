...
HD_PWD='/home/jesudara/Desktop/FPGA_projects/Vivdao/data_selector/data_selector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dataSel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dataSel.tcl
